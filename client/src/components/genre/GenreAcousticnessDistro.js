...
export default class GenreAcousticnessDistro extends React.Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        ...
        fetch("http://3.236.236.128:8081/genreAcousticnessDistro/" + genre, {
    ...
    render() {
        return (
            <>
                <p>
                    Number of songs in Genres in different acousticness buckets
                    (0 is least acoustic, 10 is most acoustic)
                </p>

...
export default class GenreMoodDistro extends React.Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        ...
        fetch("http://3.236.236.128:8081/genreMoodDistro/" + genre, {
    ...
    render() {
        return (
            <>
                <p>
                    Number of songs in Genres in different mood buckets (0 is
                    least happy/upbeat, 10 is most happy/upbeat)
                </p>
